...
% this is an app to overlay T1Pre and T1Post and be able to zoom, rotate, see the overlay on the right. 
% the observed zoom and rotation can then be input to a matlab function that will correct those dicoms and resave them.
% Mira liu march 2022 


classdef T1_DSCcoregistration < matlab.apps.AppBase
...
%% Properties that correspond to apps with auto-reflow
    ...
    methods (Access = private)
        ...
        function startupFcn(app, varargin)
            % For pre and post T1, ONCE IN NIFTI FORMAT (4d volume and all)
...
%% App creation and deletion
    methods (Access = public)
        ...
        % Construct app
        function app = T1_DSCcoregistration(varargin)
